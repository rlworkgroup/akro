...
latex_documents = [
    (master_doc, 'akro.tex', 'akro Documentation',
...
man_pages = [(master_doc, 'akro', 'akro Documentation', [author], 1)]
...
texinfo_documents = [
    (master_doc, 'akro', 'akro Documentation', author, 'akro',
